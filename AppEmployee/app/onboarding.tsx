...
const SLIDES = [
  {
    ...
    titulo: 'Trabajá cuando quieras',
    texto: 'Elegí tus horarios y tomá changas cuando te quede cómodo. Sin horario fijo: vos manejás tu tiempo.',
  },
  {
    icon: 'place' as const,
    titulo: 'Changas cerca tuyo',
    texto: 'Te conectamos con empleadores cerca de tu ubicación para que llegues rápido y sin vueltas.',
  },
  {
    icon: 'verified-user' as const,
    titulo: 'Seguro de punta a punta',
    texto: 'Verificamos identidades con DNI y selfie, y la app retiene y libera el pago. Trabajás tranquilo.',
  },
];
